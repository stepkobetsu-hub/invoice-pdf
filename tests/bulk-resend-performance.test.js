...
assert.match(source, /subject\.indexOf\(displayNumber\)<0\)subject\+='【No\. '\+displayNumber\+'】'/, 'each invoice has a distinct subject so Gmail does not hide new deliveries in one thread');
