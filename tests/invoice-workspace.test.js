...
(async()=>{
  ...
  assert.equal(document.querySelector('#invoiceWorkspace').style.getPropertyValue('--invoice-list-width'),'220px');
  assert.equal(window.localStorage.getItem('stepInvoiceSidebarWidth'),'222');
  assert.equal(window.localStorage.getItem('stepInvoiceListWidth'),'220');
